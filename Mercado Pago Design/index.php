  ...
  <div class="container">
    ...
    <div class="body">
      <div class="formulario">
        <form method="POST" action="indexx.php" class="contenido_formulario">
          <h2>¡Hola! Por favor, Ingresá tu émail y
            contraseña para reestablecer tu cuenta</h2>
          <div class="input">
            <label for="apellido" class="formulario__label">E-mail o usuario</label>
            <input type="email" class="formulario__input" name="email" id="apellido" />
          </div>
